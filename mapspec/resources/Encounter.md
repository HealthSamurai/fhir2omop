...
- **omoponfhir** (Georgia Tech, Java) — `refs/refs/omoponfhir-v54-r4/omoponfhir-omopv5-r4-mapping/src/main/java/edu/gatech/chai/omoponfhir/omopv5/r4/mapping/OmopEncounter.java` (425 lines). Bidirectional. Supports visit_detail via `partOf`, hospitalization mapping, multiple class codes.
