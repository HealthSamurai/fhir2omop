...
|---|---|---|
| `provider` | Individual healthcare provider | Yes |
...
- Specialty does NOT live on Practitioner itself -- it comes from `PractitionerRole.specialty`. See PractitionerRole mapping.
