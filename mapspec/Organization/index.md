...
Note: FHIR `Location` can also contribute care_site rows in some implementations (notably fhir-to-omop-demo). See [`../Location/care_site.md`](../Location/care_site.md).
...
- [care_site](./care_site.md) -- Organization → care_site field map, OrganizationType vocabulary, partOf hierarchy, edge cases.
